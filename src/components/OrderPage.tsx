...
import InfForPages, { AlbumItem } from "./Albums";
        ...
        <div className={classes.allInput}>
          <div className={classes.first}>
            ...
            <PhoneInput
              ...
              onChange={(e: any) => setNumberValue(e)}
              ...
              return (
                <div className={classes.cont}>
                  ...
                  <div className={classes.down}>
                    <p>
                      Genres: {item.genres.genre1}, {item.genres.genre2},{" "}
                      {item.genres.genre3}
                    </p>
                    <p>Year: {item.year}</p>
                  </div>
